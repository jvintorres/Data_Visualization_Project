...
**Campylobacteriosis** prevalence across California from 2001 to 2014. The file can be found on the "California Open Data Portal" website. This dataset was pre-processed (i.e. manipulated, filtered, augmented) from a Kaggle user. The purpose of this project was twofold - 
